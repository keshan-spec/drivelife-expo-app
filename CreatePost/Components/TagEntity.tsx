...
const TagSuggestions = ({ data, setTaggedData }: TagSuggestionsProps) => {
    ...
    const renderItem = ({ item }: {
        ...
        <View style={[
            ...
            {
                flexDirection: item.type === 'event' ? 'column' : 'row',
                alignItems: item.type === 'event' ? 'flex-start' : 'center',
            ...
            >
                <View style={[
                    ...
                    {
                        width: item.type === 'event' ? 60 : 32,
                        height: item.type === 'event' ? 60 : 32,
                    },
                ...
                <View style={{
                    ...
                    maxWidth: item.type === 'event' ? '90%' : '100%',
                }}>
                    <Text
                        style={{
            ...
            <TouchableOpacity onPress={() => handleTagClick(item)}
                style={{
                    ...
                    paddingVertical: 6,
                    borderRadius: 4,
                    marginLeft: item.type === 'event' ? 66 : 'auto',
                }}
            >
                <Text
                    style={{
